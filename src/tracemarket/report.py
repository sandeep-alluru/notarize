"""Rich terminal, JSON, and Markdown output formatters for tracemarket."""
...
def to_markdown(results: list[VerificationResult]) -> str:
    ...
    """
    if not results:
        return "## tracemarket verification report\n\nNo verification results to report.\n"
    ...
    lines = [
        "## tracemarket verification report",
        "",
    ...
    lines += [
        ...
        "</details>",
        "",
        "*Generated by [tracemarket](https://github.com/sandeep-alluru/tracemarket)*",
    ]
    return "\n".join(lines)
