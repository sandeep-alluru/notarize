...
from notarize.paths import connect_sqlite, ensure_parent_dir, resolve_store_path
...
class TraceStore:
    ...
    def __init__(self, path: str | Path) -> None:
        full, base = resolve_store_path(path, env_var="NOTARIZE_DATA_DIR", default_name="traces.db")
